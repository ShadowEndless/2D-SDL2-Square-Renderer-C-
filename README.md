...
- 🖥️ Real-time rendering using SDL2  
- ⏱️ Frame rate control and delta time calculation  
- 🎮 Event handling (keyboard and window events)  
- 🎞️ Basic animation and movement logic  
...
- ⏱️ Use of delta time for frame-independent animation
...
## 🔮 Future Improvements
- ➡️ Add horizontal movement and user input controls
- 🧱 Introduce multiple objects
- ⚖️ Implement basic physics (acceleration, gravity)
- 🏗️ Expand into a simple 2D engine structure
